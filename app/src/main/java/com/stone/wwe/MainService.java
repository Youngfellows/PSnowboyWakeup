...
public class MainService extends Service implements IWweCallback {
    ...
    public void onCreate() {
        ...
        Log.d(TAG, "onCreate: ALEXA_UMDL: " + ALEXA_UMDL);
        Log.d(TAG, "onCreate: COMMON_RES: " + COMMON_RES);
    ...
    private void startKeywordDetect() {
        ...
        Log.d(TAG, "start keyword detect .......");
    ...
    public void onKeyWordDetect(int count) {
        ...
        Log.w(TAG, "key word detect wake up .... " + count);
    }
